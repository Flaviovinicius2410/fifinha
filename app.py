...
ax_top_10_brazilian_players.barh(top_10_brazilian_players['name'], top_10_brazilian_players['overall'], color='green')
...
ax_bottom_10_brazilian_players.barh(bottom_10_brazilian_players['name'], bottom_10_brazilian_players['overall'], color='red')
...
ax_top_10_oldest_players.barh(top_10_oldest_players['name'], top_10_oldest_players['age'], color='purple')
ax_top_10_oldest_players.set_ylabel('Jogadores')
ax_top_10_oldest_players.set_xlabel('Idade')
